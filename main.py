# # main.py - Optimized Full-Screen Study Fit Advisor
...
#             """Format Prolog output with beautiful text styling"""
#             lines = raw_output.split('\n')
            
#             for line in lines:
#                 if '╔' in line or '╚' in line:
#                     text_result.insert(tk.END, line + '\n', 'box_border')
#                 elif '║' in line and 'SMART STUDY FIT' in line:
#                     text_result.insert(tk.END, line + '\n', 'main_title')
#                 elif '║' in line:
#                     text_result.insert(tk.END, line + '\n', 'subtitle')
...
#                     parts = line.split(':', 1)
#                     if len(parts) == 2:
#                         text_result.insert(tk.END, parts[0] + ': ', 'label')
#                         text_result.insert(tk.END, parts[1] + '\n', 'value')
#                     else:
#                         text_result.insert(tk.END, line + '\n')
#                 else:
#                     text_result.insert(tk.END, line + '\n')
...
#                 text_result.insert('1.0', f"⚠️ Error generating plan\n\n{result.stderr}", 'error')
...
#             text_result.config(state='normal')
#             text_result.delete('1.0', tk.END)
#             text_result.insert('1.0', f"⚠️ Error: {e}", 'error')
#             text_result.config(state='disabled')
#             btn_generate.config(state='normal', text="✨ Generate Study Plan")
...
# tk.Label(header, text="Study Preparation Advisor", font=TITLE_FONT, 
...
# q4_frame = add_compact_question(q_container, 1, 1, 4, "What time of day are you most energized?")
...
# q6_frame = add_compact_question(q_container, 2, 1, 6, "Which sound environment helps you focus best?")
...
# # Row 3: Q7 | Q8
# q7_frame = add_compact_question(q_container, 3, 0, 7, "Do you prefer studying alone or with a group?")
# combo7 = ttk.Combobox(q7_frame, values=["Alone", "1 friend", "2–3 friends"], width=18, 
#                       state="readonly", font=LABEL_FONT, style='Custom.TCombobox')
# combo7.set("Alone")
# combo7.pack(anchor="w", pady=(2, 0))

# q8_frame = add_compact_question(q_container, 3, 1, 8, "Do you prefer to sit at a desk or move around?")
...
# # Row 4: Q9 | Q10
# q9_frame = add_compact_question(q_container, 4, 0, 9, "For which exam part are you preparing?")
# combo9 = ttk.Combobox(q9_frame, values=["MCQ", "Essay", "Practical", "Viva"], width=18, 
#                       state="readonly", font=LABEL_FONT, style='Custom.TCombobox')
# combo9.set("MCQ")
# combo9.pack(anchor="w", pady=(2, 0))

# q10_frame = add_compact_question(q_container, 4, 1, 10, "Do you forget answers or go blank when the clock is ticking?")
# var10 = tk.BooleanVar()
...
# # Configure text tags
# text_result.tag_configure("box_border", foreground="#666666", font=("Courier", 8))
# text_result.tag_configure("main_title", font=(TITLE_FONT[0], 12, "bold"), foreground=TEXT_PRIMARY)
# text_result.tag_configure("subtitle", font=RESULT_FONT, foreground=TEXT_PRIMARY)
# text_result.tag_configure("section_header", font=SECTION_FONT, foreground=TEXT_PRIMARY, 
#                          spacing1=6, spacing3=3)
# text_result.tag_configure("separator", foreground=BORDER)
# text_result.tag_configure("bullet", foreground=TEXT_PRIMARY, font=RESULT_FONT)
# text_result.tag_configure("label", foreground=TEXT_PRIMARY, font=RESULT_FONT)
